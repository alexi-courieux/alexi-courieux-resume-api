...
def get_experience(db: Session, company: str, language: str) -> ExperienceSchema:
    sql = text("""
        SELECT e.ID as id, ei18n.COMPANY_NAME as company_name, ei18n.POSITION as position, e.START_DATE as start_date, e.END_DATE as end_date, ei18n.SHORT_DESCRIPTION as short_description, ei18n.DESCRIPTION as description
        FROM EXPERIENCE e
        JOIN EXPERIENCE_I18N ei18n ON e.ID = ei18n.EXPERIENCE_ID
        WHERE e.ID = :company AND ei18n.LANGUAGE = :language
        LIMIT 1
    """)
